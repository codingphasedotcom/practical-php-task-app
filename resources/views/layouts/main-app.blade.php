        ...
        <div class="">
            ...
            <section class="relative">
                ...
                <div class="container mx-auto overflow-hidden">
                    <div
                        class="relative z-20 flex items-center justify-between px-4 py-5 bg-transparent"
                    >
                        <div class="w-auto">
                    ...
                    >
                        ...
                        >
                            <div class="flex flex-wrap justify-between h-full">
                                ...
                                <div
                                    class="flex flex-col justify-center py-16 w-full"
                                >
                                    <ul>
                                        <li class="mb-12">
                                            <a
                                ...
                                <div
                                    class="flex flex-col justify-end w-full pb-8"
                                >
            ...
            <section class="pt-24 bg-white overflow-hidden">
                <div class="container px-4 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-8">
                            ...
                            <div class="w-full sm:w-1/2 lg:w-4/12 p-8">
                                <div class="lg:max-w-sm">
                                    <h3
                                        class="mb-6 font-semibold leading-normal"
                                    >
                                        Subscribe
                                    </h3>
                                    <p
                                        class="mb-5 font-sans text-gray-600 leading-relaxed"
                                    >
                    ...
                    <div
                        class="flex flex-wrap justify-between items-center py-6 -m-4"
                    >
